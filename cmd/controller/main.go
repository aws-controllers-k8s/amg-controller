...
import (
	...
	svctypes "github.com/aws-controllers-k8s/amg-controller/apis/v1alpha1"
	svcresource "github.com/aws-controllers-k8s/amg-controller/pkg/resource"

	"github.com/aws-controllers-k8s/amg-controller/pkg/version"
)

var (
	awsServiceAPIGroup = "amg.services.k8s.aws"
	awsServiceAlias    = "amg"
